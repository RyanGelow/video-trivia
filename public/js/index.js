...
/*----------------------------------------------------*/
   ...
   $('.portfolio-button').on('click', function() {
      $('.portfolio-section').toggleClass("hide");
      $('.portfolio-button').toggleClass("less")
      if($('.portfolio-button').hasClass("less")){
         $('.portfolio-button').text("Show Less Works")
      } else {
         $('.portfolio-button').text("Show More Works")
      }
   })
